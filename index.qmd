...
Participants often rate values as missing, which makes sense given that lyrics are short snippets, and gaining a complete perspective of the values of the "Speaker" is unlikely. 

![](images/wave_participant_rating_distribution.png){fig-align="center"}
LLMs show a rather different distribution, with no NA values, but values that generally sit on the low end of the scale:
